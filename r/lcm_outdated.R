...
# lcm.original@legend@colortable[20] <- '#FF0000'
lcm.original@crs@projargs
...
new.coord <- repro.modis.fun(data.frame(x = c(150.73394,144.619028,146.641889,141.712600),y=-c(33.610412,26.577250,31.645194,29.607250)))

points(x = new.coord$x,y=new.coord$y,
       pch=3,col=col.df$reptile[2],cex=1)
